  ...
  return (
    <div className="p-8">
      ...
      <div className="space-y-8">
        ...
        {isEmpty(menu.filter((data) => data?.category === 'Starters')) && (
          <div className="flex flex-col items-center justify-center p-8 bg-white/50 rounded-lg">
            ...
            <p className="text-sm text-gray-500">Please add some items to the "Starters" category.</p>
          </div>
        )}

        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {menu
            .filter((data) => data?.category === 'Starters').map((item) => (
